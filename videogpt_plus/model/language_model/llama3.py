...
class VideoGPTPlusConfig(LlamaConfig):
    model_type = "VideoGPT+"


class VideoGPTPlusLlama3Model(MetaModel, LlamaModel):
    config_class = VideoGPTPlusConfig

    def __init__(self, config: LlamaConfig):
        super(VideoGPTPlusLlama3Model, self).__init__(config)


class VideoGPTPlusLlama3ForCausalLM(LlamaForCausalLM, VideoGPTPlusMetaForCausalLM):
    config_class = VideoGPTPlusConfig

    def __init__(self, config):
        super(LlamaForCausalLM, self).__init__(config)
        self.model = VideoGPTPlusLlama3Model(config)
...
AutoModelForCausalLM.register(VideoGPTPlusConfig, VideoGPTPlusLlama3ForCausalLM) 